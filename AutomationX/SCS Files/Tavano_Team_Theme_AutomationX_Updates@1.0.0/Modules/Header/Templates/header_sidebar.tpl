<div class="header-sidebar-wrapper">
	...
	<div data-view="StoreLocatorHeaderLink" class="StoreLocator"></div>
	<div data-view="RequestQuoteWizardHeaderLink" class="RequestQuote"></div>
	<div data-view="QuickOrderHeaderLink" class="QuickOrder"></div>
