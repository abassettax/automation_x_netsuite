...
var cate= nlapiLoadSearch('sitecategory', '2478');   //load saved search-jf
...
var preserve7=0;
var preserve8=0;
//var output="<div id=\"dcjq-vertical-mega-menu\"><ul id=\"mega-1\" class=\"menu\">";
var output="";
runcate .forEachResult(function(searchResult)
	{
	var name = searchResult.getValue( 'fullname' );
	var url= "http://test.automation-x.com/"+searchResult.getValue( 'urlcomponent' ); //get url value -jf
	var priority= searchResult.getValue( 'sitemappriority');
...
if(stripper!=preserve&&bananasplit[1]==undefined)
{
...
output=output+"<li class=\"sub1\" value=\""+priority+"\"><a href="+url+">"+firstlvl+"</a>";
 //output=output+"<li class=\"sub1\" value=\""+priority+"\"><a href=\"/"+url+"\">"+firstlvl+"</a>";
	preserve=stripper;
}
////////
...
if(stripper1!=preserve1&&bananasplit[2]==undefined) //check to see if parse has already been written -jf
{
if(counter==1){output=output+"</ul></li>";counter=0;}
if(counter2==1){output=output+"</ul></li>";counter2=0;}//checks if we have been to thirdlvl if so close
if(counter3==1){output=output+"</ul></li>";counter3=0;}//checks if we have been to forthlvl if so close
if(counter4==1){output=output+"</ul></li>";counter4=0;}//checks if we have been to fifthlvl if so close
if(counter5==1){output=output+"</ul></li>";counter5=0;}//checks if we have been to sixthlvl if so close
if(counter6==1){output=output+"</ul></li>";counter6=0;}//checks if we have been to seventhlvl if so close
if(counter7==1){output=output+"</ul></li>";counter7=0;}//checks if we have been to eighthlvl if so close


	output=output+"<li class=\"sub1\" value=\""+priority+"\"><a href="+url+">"+secondlvl+"</a>"; //separate each menu item-jf
preserve1=stripper1;

if (counter==0) //checks to see if this is the first writing -jf
{output=output+"<ul id=\"xsort\">";counter=1; } //opens container -jf
}
////////
...
if(stripper2!=preserve2&&bananasplit[3]==undefined)
{
if(counter2==1){output=output+"</ul>";counter2=0;}//checks if we have been to thirdlvl if so close
if(counter3==1){output=output+"</ul>";counter3=0;}//checks if we have been to forthlvl if so close
if(counter4==1){output=output+"</ul>";counter4=0;}//checks if we have been to fifthlvl if so close
...
if(counter7==1){output=output+"</ul>";counter7=0;}//checks if we have been to eighthlvl if so close
	...
	output=output+"<li value=\""+priority+"\"><a href="+url+">"+thirdlvl+"</a>"; //</li>separate each menu item-jf
preserve2=stripper2;
if (counter2==0) //checks to see if this is the first writing -jf
{output=output+"<ul  id=\"ysort\">";counter2=1; } //opens container -jf
}
////////
...
if(stripper3!=preserve3&&bananasplit[4]==undefined)
{
if(counter3==1){output=output+"</ul>";counter3=0;}//checks if we have been to forthlvl if so close
if(counter4==1){output=output+"</ul>";counter4=0;}//checks if we have been to fifthlvl if so close
if(counter5==1){output=output+"</ul>";counter5=0;}//checks if we have been to sixthlvl if so close
...
if(counter7==1){output=output+"</ul>";counter7=0;}//checks if we have been to eighthlvl if so close
	...
	output=output+"<li value=\""+priority+"\"><a href="+url+">"+fourthlvl+"</a></li>"; //separate each menu item-jf
preserve3=stripper3;
...
if(stripper4!=preserve4&&bananasplit[5]==undefined)
{
if(counter4==1){output=output+"</ul>";counter4=0;}//checks if we have been to fifthlvl if so close
if(counter5==1){output=output+"</ul>";counter5=0;}//checks if we have been to sixthlvl if so close
if(counter6==1){output=output+"</ul>";counter6=0;}//checks if we have been to seventhlvl if so close
...
if(stripper5!=preserve5&&bananasplit[6]==undefined)
{
if(counter5==1){output=output+"</ul>";counter5=0;}//checks if we have been to sixthlvl if so close
if(counter6==1){output=output+"</ul>";counter6=0;}//checks if we have been to seventhlvl if so close
if(counter7==1){output=output+"</ul>";counter7=0;}//checks if we have been to eighthlvl if so close
...
if(stripper6!=preserve6&&bananasplit[7]==undefined)
{
if(counter6==1){output=output+"</ul>";counter6=0;}//checks if we have been to seventhlvl if so close
if(counter7==1){output=output+"</ul>";counter7=0;}//checks if we have been to eighthlvl if so close
...
if (callBackFuncStr != null){

		//simply wrap the data in to a javascript function call that will execute on the client
		//as soon as it is returned; remember, your client side function has to be there named
		//appropriate to receive the result
		var strJson = callBackFuncStr+'(\''+JSON.stringify(output)+'\');';
		nlapiLogExecution('DEBUG', 'JSONP Offer', strJson);
		response.write(strJson);

	} else {

		//basic JSON request; works great in server-to-server implemenations
		
		//return basic JSON without concern for Same Orgin Policy
