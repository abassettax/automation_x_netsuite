 ...
 */
define(["require", "exports", "./PurchaseRequestItemDetail", "./DH_Library", "N/search", "N/task", "N/runtime", "N/log", "N/redirect", "./DH_PurchaseRequest_Engine",
'/SuiteBundles/Bundle 310544/TJINC_NS_Library_SS21'],
    function (require, exports, PurchaseRequestItemDetail_1, DH_Library_1, search, task, runtime, log, redirect, DH_PurchaseRequest_Engine_1, tj) {
                    ...
                    if (isProcessable(context, i) && !(relatedTransactionId > 0) && (purchaseRequestId === DUMMY_PR || !(purchaseRequestId > 0))) {
                        switch (createType) {
                            ...
                            case PurchaseRequestItemDetail_1.CreateType.WillCallPO:
                                ...
                                var i_cost;
                                if (costEstimateType === 'CUSTOM') {
                                    i_cost = context.newRecord.getSublistValue({ sublistId: 'item', line: i, fieldId: 'costestimaterate' }) || 0;
                                } else {
                                    var o_cost_search = tj.searchAll({
