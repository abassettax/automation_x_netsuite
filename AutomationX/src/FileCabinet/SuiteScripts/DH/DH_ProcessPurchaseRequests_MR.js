 ...
 */
define(["require", "exports", "N/runtime", "N/search", "N/url", "N/email", "N/log", "./DH_Library", "./DH_ProcessManager", "./DH_PurchaseRequest_Engine"], function (require, exports, runtime, search, url, email, log, DH_Library_1, DH_ProcessManager_1, DH_PurchaseRequest_Engine_1) {
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.getInputData = function () {
        return DH_PurchaseRequest_Engine_1.determineTransactions({
            employeeId: +runtime.getCurrentScript().getParameter({ name: 'custscript_dh_employee' }),
            purchaseRequests: JSON.parse(runtime.getCurrentScript().getParameter({ name: 'custscript_dh_purchaserequests' }))
        });
    };
    ...
    exports.summarize = function (context) {
        ...
        var employeeId = +runtime.getCurrentScript().getParameter({ name: 'custscript_dh_employee' });
