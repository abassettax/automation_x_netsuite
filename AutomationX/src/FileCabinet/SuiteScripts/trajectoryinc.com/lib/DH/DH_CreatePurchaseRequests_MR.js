 ...
 */
 define(["require", "exports", "N/runtime", "N/task", "N/log", "./DH_Library", "./DH_PurchaseRequest_Engine"], 
    function (require, exports, runtime, task, log, DH_Library_1, DH_PurchaseRequest_Engine_1) {
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.getInputData = function () {
        var purchaseRequests = JSON.parse(runtime.getCurrentScript().getParameter({ name: 'custscript_tjinc_dh_sopurchaserequests' }));
    ...
    exports.summarize = function (context) {
        ...
        var employeeId = +runtime.getCurrentScript().getParameter({ name: 'custscript_tjinc_dh_owner' });
