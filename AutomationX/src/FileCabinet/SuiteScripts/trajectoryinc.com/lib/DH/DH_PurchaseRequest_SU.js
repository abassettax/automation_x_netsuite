...
define(["require", "exports", "N/log", "N/record", "N/url", "N/https", "N/search", "N/format", "N/runtime", "N/task", "N/ui/serverWidget", "./DH_Library", "./PurchaseRequestItemDetail", "./DH_ProcessManager"],
    function (require, exports, log, record, url, https, search, format, runtime, task, serverWidget, DH_Library_1, PurchaseRequestItemDetail_1, DH_ProcessManager_1) {
        ...
        var getHandler = function (context) {
            ...
            var stockRequests = getStockRequests(clearAll, locationId, isNormallyStocked, prType, purchMethod, ax5code);
        ...
        var getStockRequests = function (clearAll, locationId, isNormallyStocked, prType, purchMethod, ax5code) {
            log.debug({
                title: 'getStockRequests params',
                details: clearAll + ' | ' + locationId + ' | ' + isNormallyStocked + ' | ' + prType + ' | ' + purchMethod
            });
            var stockRequests = [], purchaseRequestItemDetails = getPurchaseRequestItemDetails(clearAll, locationId, isNormallyStocked, prType, purchMethod, ax5code);
            log.debug({
        ...
        var getPurchaseRequestItemDetails = function (clearAll, locationId, isStock, prType, purchMethod, ax5code) {
            ...
            search.create({
                ...
                columns: [
                    ...
                    search.createColumn({ name: 'custrecord353' })//37 does not accept alternates checkbox added
                ]
                ...
                var purchaseRequestItemDetail = {
                    ...
                    noAlts: result.getValue(result.columns[37])
                };
