...
/*
 * @Function: roundUpCurrency @Purpose: This function loads @Parameters: Type (default) Defaults record Type Name (default) the field that is being updated linenum (default) the line index of the lineitem @Returns: N/A
 */
...
/*
 * @Function: getCustomCodeValue @Purpose: This function loads @Parameters: Type (default) Defaults record Type Name (default) the field that is being updated linenum (default) the line index of the lineitem @Returns: N/A
 */
