function salesLinksCard(request, response) {
  ...
  var content = ''
  content += "<table font-family: \"Arial\"; style=\"font-size:18px;\" ><tr><td  width=\"20\%\" bgcolor=\"#dadada\" align= \"center\"><a href=\"" + searchUrl21 + "\" target=\"_blank\" style=\"color:black; display:block; text-decoration: none\">" + searchName21 +"</a></td><td  width=\"20\%\" bgcolor=\"#dadada\" align= \"center\"><a href=\"" + searchUrl22 + "\" target=\"_blank\" style=\"color:black; display:block; text-decoration: none\">" + searchName22 +"</a></td><td  width=\"20\%\" bgcolor=\"#dadada\" align= \"center\"><a href=\"" + searchUrl23 + "\" target=\"_blank\" style=\"color:black; display:block; text-decoration: none\">" + searchName23 +"</a></td></tr>";
  content += "<tr><td  width=\"20\%\" bgcolor=\"#dadada\" align= \"center\"><a href=\"" + searchUrl1 + "\" target=\"_blank\" style=\"color:black; display:block; text-decoration: none\">" + searchName1 +"</a></td><td  width=\"20\%\" bgcolor=\"#dadada\" align= \"center\"><a href=\"" + searchUrl2 + "\" target=\"_blank\" style=\"color:black; display:block; text-decoration: none\">" + searchName2 +"</a></td><td  width=\"20\%\" bgcolor=\"#dadada\" align= \"center\"><a href=\"" + searchUrl3 + "\" target=\"_blank\" style=\"color:black; display:block; text-decoration: none\">" + searchName3 +"</a></td></tr>";
  ...
  content += "<tr><td  width=\"20\%\" bgcolor=\"#dadada\" align= \"center\"><a href=\"" + searchUrl19 + "\" target=\"_blank\" style=\"color:black; display:block; text-decoration: none\">" + searchName19 +"</a></td><td  width=\"20\%\" bgcolor=\"#dadada\" align= \"center\"><a href=\"" + searchUrl20 + "\" target=\"_blank\" style=\"color:black; display:block; text-decoration: none\">" + searchName20 +"</a></td></tr></table>";
