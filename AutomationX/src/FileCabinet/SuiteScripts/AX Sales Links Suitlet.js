function salesLinksCard(request, response) {
  ...
  content += "<tr><td  width=\"20\%\" bgcolor=\"#dadada\" align= \"center\"><a href=\"" + searchUrl19 + "\" target=\"_blank\" style=\"color:black; display:block; text-decoration: none\">" + searchName19 +"</a></td><td  width=\"20\%\" bgcolor=\"#dadada\" align= \"center\"><a href=\"" + searchUrl20 + "\" target=\"_blank\" style=\"color:black; display:block; text-decoration: none\">" + searchName20 +"</a></td><td  width=\"20\%\" bgcolor=\"#dadada\" align= \"center\"><a href=\"" + searchUrl12 + "\" target=\"_blank\" style=\"color:black; display:block; text-decoration: none\">" + searchName12 +"</a></td></tr></table>";

  content += "<p>CRM</p><table font-family: \"Arial\"; style=\"font-size:18px; width: 100%;\" ><tr><td  width=\"20\%\" bgcolor=\"#dadada\" align= \"center\"><a href=\"" + searchUrl24 + "\" target=\"_blank\" style=\"color:black; display:block; text-decoration: none\">" + searchName24 +"</a></td><td  width=\"20\%\" bgcolor=\"#dadada\" align= \"center\"><a href=\"" + searchUrl25 + "\" target=\"_blank\" style=\"color:black; display:block; text-decoration: none\">" + searchName25 +"</a></td><td  width=\"20\%\" bgcolor=\"#dadada\" align= \"center\"><a href=\"" + searchUrl26 + "\" target=\"_blank\" style=\"color:black; display:block; text-decoration: none\">" + searchName26 +"</a></td></tr>";
