...
function adjustcostestimate() {
    ...
    function startRFQ() {
        ...
        var vendor = nlapiGetCurrentLineItemValue('item', 'custcol125');
        var date = nlapiGetCurrentLineItemValue('item', 'custcol126'); 

        window.open('https://422523.app.netsuite.com/app/site/hosting/scriptlet.nl?script=2472&deploy=1&compid=422523&type=1&itemid=' + itemId + '&qty=' + qty + '&vendor=' + vendor + '&deadline=' + date, "newwin", "dependent = yes, height=" + h + ", width=" + w + ", top=100, left=200, toolbar=no, scrollbars=yes, menubar=no, status=no, titlebar=no, resizable=yes, location=no");
        return true;
    }
