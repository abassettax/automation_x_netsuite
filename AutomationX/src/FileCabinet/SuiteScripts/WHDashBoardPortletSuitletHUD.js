...
cyclecountdaterange = "lastmonth"; defaultcyclecountlabel = "Defaults to Last Month";
invadjustmentrange = "lastmonth";  defaultinvadjmentlabel = "Defaults to Last Month";
missreportdaterange = "lastmonth"; defaultmisslabel = "Defaults to Last Month";
...
columnsA
  ...
  //////////////////////// Cycle count info
	var columnsB = new Array();
     ...
     columnsB[1] =    new nlobjSearchColumn("item",null,"COUNT");
...
var countlocation = inventorycountSearch[b].getValue(columnsB[3]);
   if(countlocation == locationID)
     {
itemscounted = inventorycountSearch[b].getValue(columnsB[1]); if(!itemscounted){itemscounted=0;}
itemsoff = inventorycountSearch[b].getValue(columnsB[2]); if(!itemsoff){itemsoff=0;}
